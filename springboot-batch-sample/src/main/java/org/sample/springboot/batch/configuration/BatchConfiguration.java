...
public class BatchConfiguration {
	...
	public LineMapper<Voltage> lineMapper() {
		...
		final DefaultLineMapper<Voltage> defaultLineMapper = new DefaultLineMapper<Voltage>();
	...
	public JdbcBatchItemWriter<Voltage> writer(final DataSource dataSource) {
		return new JdbcBatchItemWriterBuilder<Voltage>()
				.itemSqlParameterSourceProvider(new BeanPropertyItemSqlParameterSourceProvider<Voltage>())
