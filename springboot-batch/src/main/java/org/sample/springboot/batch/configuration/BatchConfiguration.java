...
public class BatchConfiguration {
    ...
    @Bean public FlatFileItemReader<Voltage> reader() {
    ...
    @Bean public LineMapper<Voltage> lineMapper() {
    ...
    @Bean public VoltageProcessor processor() {
        return new VoltageProcessor();
    }

    @Bean public JdbcBatchItemWriter<Voltage> writer(final DataSource dataSource) {
    ...
    @Bean public Step step1(JdbcBatchItemWriter<Voltage> writer) {
    ...
    @Bean public Job importVoltageJob(NotificationListener listener, Step step1) {
